      ...
      <div className="bg-white shadow rounded-lg">
        <div className="p-6">
          <div className="space-y-6">
            ...
            {/* Stripe支付配置 */}
            <div>
              <h3 className="text-lg font-medium text-gray-900 mb-4">Stripe 支付配置</h3>
              <div className="space-y-4">
                {/* Stripe开关 */}
                <div className="flex items-center">
                  <input
                    ...
                    className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500"
                  />
                  <label htmlFor="stripe_enabled" className="ml-2 text-sm font-medium text-gray-700">
                    启用 Stripe 支付服务
                  </label>
                </div>
                  ...
                  <>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div>
                        ...
                        />
                        <p className="mt-1 text-xs text-gray-500">以 pk_ 开头的公开密钥</p>
                      </div>

                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-2">
                          Stripe 私密密钥 (Secret Key)
                        </label>
                        <input
                          type="password"
                        ...
                        />
                        <p className="mt-1 text-xs text-gray-500">以 sk_ 开头的私密密钥，仅服务器使用</p>
                      </div>
                      ...
                      <div>
                        ...
                        <input
                          ...
                          placeholder="whsec_..."
                        />
                        <p className="mt-1 text-xs text-gray-500">用于验证 Stripe Webhook 的签名</p>
                      </div>
                      ...
                      <div>
                        ...
                        <select
                          value={config.stripe_country}
                          onChange={(e) => handleChange('stripe_country', e.target.value)}
                          className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                        >
                      ...
                      <div className="flex items-center">
                        <input
                          ...
                          className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500"
                        />
                        <label htmlFor="stripe_test_mode" className="ml-2 text-sm font-medium text-gray-700">
                          测试模式（使用测试密钥）
                        </label>
                        <p className="ml-2 text-xs text-gray-500">生产环境请取消勾选</p>
                      </div>
                    </div>
                    ...
                    <div className="bg-blue-50 border border-blue-200 rounded-md p-4">
                      <div className="flex">
                        ...
                        <div className="ml-3">
                          <h4 className="text-sm font-medium text-blue-800">Stripe 配置提示</h4>
                          <div className="mt-2 text-sm text-blue-700">
                            <ul className="list-disc pl-5 space-y-1">
                              <li>测试环境：使用以 pk_test_ 和 sk_test_ 开头的测试密钥</li>
                              <li>生产环境：使用以 pk_live_ 和 sk_live_ 开头的生产密钥</li>
                              <li>Webhook 端点：请在 Stripe 后台设置为 {typeof window !== 'undefined' ? window.location.origin : 'your-domain'}/api/webhooks/stripe</li>
                              <li>需要启用的事件：payment_intent.succeeded, payment_intent.payment_failed</li>
                              <li>请确保您的 Stripe 账户已完成验证并启用了相应的支付方式</li>
                            </ul>
                          </div>
                        </div>
                      </div>
