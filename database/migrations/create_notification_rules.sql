...
CREATE TABLE IF NOT EXISTS notification_rules (
  ...
  name TEXT NOT NULL,
  description TEXT,
  type TEXT NOT NULL, -- balance_low, subscription_expiring, usage_limit, payment_failed等
...
-- 插入默认通知模板
INSERT OR IGNORE INTO notification_templates (id, name, title, message, type, priority, action_url, variables) VALUES
...
-- 插入默认通知规则
INSERT OR IGNORE INTO notification_rules (id, name, description, type, trigger_condition, template_id, target_scope, is_enabled, cooldown_minutes, created_by) VALUES
