...
REPLACE INTO `plan_categories` (`id`, `name`, `display_name`, `description`, `icon`, `color`, `sort_order`, `is_featured`) VALUES
...
REPLACE INTO `plans` (`id`, `name`, `display_name`, `description`, `price`, `currency`, `duration_days`, `requests_limit`, `tokens_limit`, `models`, `features`, `priority_support`, `is_popular`, `is_active`, `sort_order`, `category_id`) VALUES
-- 免费体验版
