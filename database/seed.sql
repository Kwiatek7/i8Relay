...
INSERT OR REPLACE INTO plan_categories (id, category_name, display_name, description, icon, color, sort_order, is_featured) VALUES
...
INSERT OR REPLACE INTO plans (id, plan_name, display_name, description, price, currency, duration_days, requests_limit, tokens_limit, models, features, priority_support, is_popular, is_active, sort_order, category_id) VALUES
-- 免费体验版
...
INSERT OR REPLACE INTO system_config (category, config_key, config_value, data_type, description, is_public) VALUES
-- 网站基础配置
